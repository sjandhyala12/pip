// pets/alien.js — SVG art for the alien.
...
export const alien = {
  ...
  hatch(fill) {
    ...
    <line x1="88" y1="46" x2="78" y2="26" stroke="#35315F" stroke-width="4" stroke-linecap="round"></line><circle cx="78" cy="24" r="5" fill="${fill}" stroke="#35315F" stroke-width="3"></circle><line x1="112" y1="46" x2="122" y2="26" stroke="#35315F" stroke-width="4" stroke-linecap="round"></line><circle cx="122" cy="24" r="5" fill="${fill}" stroke="#35315F" stroke-width="3"></circle>
  ...
  kid(fill) {
    ...
    <line x1="88" y1="52" x2="78" y2="30" stroke="#35315F" stroke-width="4" stroke-linecap="round"></line><circle cx="78" cy="28" r="5.5" fill="${fill}" stroke="#35315F" stroke-width="3"></circle><line x1="112" y1="52" x2="122" y2="30" stroke="#35315F" stroke-width="4" stroke-linecap="round"></line><circle cx="122" cy="28" r="5.5" fill="${fill}" stroke="#35315F" stroke-width="3"></circle>
  ...
  big(fill) {
    ...
    <line x1="86" y1="46" x2="74" y2="24" stroke="#35315F" stroke-width="4" stroke-linecap="round"></line><circle cx="74" cy="22" r="6" fill="${fill}" stroke="#35315F" stroke-width="3"></circle><line x1="114" y1="46" x2="126" y2="24" stroke="#35315F" stroke-width="4" stroke-linecap="round"></line><circle cx="126" cy="22" r="6" fill="${fill}" stroke="#35315F" stroke-width="3"></circle>
  ...
  star(fill) {
    ...
    <line x1="80" y1="52" x2="64" y2="32" stroke="#35315F" stroke-width="4" stroke-linecap="round"></line><circle cx="64" cy="30" r="6" fill="${fill}" stroke="#35315F" stroke-width="3"></circle><line x1="120" y1="52" x2="136" y2="32" stroke="#35315F" stroke-width="4" stroke-linecap="round"></line><circle cx="136" cy="30" r="6" fill="${fill}" stroke="#35315F" stroke-width="3"></circle>
