// pets/puppy.js — SVG art for the puppy.
...
export const puppy = {
  ...
  hatch(fill) {
    ...
    <path d="M72 52 Q56 44 54 76 Q54 92 66 88 Q72 72 74 56 Z" fill="${fill}" stroke="#35315F" stroke-width="4" stroke-linejoin="round"></path><path d="M128 52 Q144 44 146 76 Q146 92 134 88 Q128 72 126 56 Z" fill="${fill}" stroke="#35315F" stroke-width="4" stroke-linejoin="round"></path>
    ...
    <ellipse cx="100" cy="88" rx="5" ry="4" fill="#35315F"></ellipse>
  ...
  kid(fill) {
    ...
    <path d="M66 58 Q48 50 46 86 Q46 104 60 98 Q66 80 68 62 Z" fill="${fill}" stroke="#35315F" stroke-width="4" stroke-linejoin="round"></path><path d="M134 58 Q152 50 154 86 Q154 104 140 98 Q134 80 132 62 Z" fill="${fill}" stroke="#35315F" stroke-width="4" stroke-linejoin="round"></path>
    ...
    <ellipse cx="100" cy="102" rx="5.5" ry="4.5" fill="#35315F"></ellipse>`;
  },

  big(fill) {
    return `
    <ellipse cx="100" cy="156" rx="66" ry="12" fill="#35315F" opacity="0.08"></ellipse>
    <path d="M62 52 Q42 44 40 84 Q40 104 56 98 Q62 78 64 56 Z" fill="${fill}" stroke="#35315F" stroke-width="4" stroke-linejoin="round"></path><path d="M138 52 Q158 44 160 84 Q160 104 144 98 Q138 78 136 56 Z" fill="${fill}" stroke="#35315F" stroke-width="4" stroke-linejoin="round"></path>
    ...
    <ellipse cx="100" cy="100" rx="6" ry="5" fill="#35315F"></ellipse>`;
  },
  ...
  star(fill) {
    ...
    <path d="M60 56 Q40 48 38 88 Q38 108 54 102 Q60 82 62 60 Z" fill="${fill}" stroke="#35315F" stroke-width="4" stroke-linejoin="round"></path><path d="M140 56 Q160 48 162 88 Q162 108 146 102 Q140 82 138 60 Z" fill="${fill}" stroke="#35315F" stroke-width="4" stroke-linejoin="round"></path>
    ...
    <ellipse cx="100" cy="102" rx="6" ry="5" fill="#35315F"></ellipse>
